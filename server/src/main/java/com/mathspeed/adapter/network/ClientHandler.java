...
import com.mathspeed.application.game.GameSession;
...
public class ClientHandler implements Runnable {
    ...
    private void handleRegister(String[] parts) {
        ...
        try {
            ...
            newPlayer.setPasswordHash(PlayerRepository.hashPassword(password));
            newPlayer.setDisplayName(username);
            newPlayer.setGender(gender);
            newPlayer.setAvatarUrl(null);

            boolean success = PlayerRepository.insertPlayer(newPlayer);
    ...
    private void handleLogin(String[] parts) {
        ...
        Player p;
        try {
            p = PlayerRepository.findPlayer(username, password);
        } catch (Exception e) {
